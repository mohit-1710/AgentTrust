...
[`@monad-agenttrust-sdk/sdk`](https://www.npmjs.com/package/@monad-agenttrust-sdk/sdk) is the TypeScript package every facilitator pulls in. Express middleware, client helpers for direct calls, the atomicity guard, contract account derivers + Solidity loaders for all three programs, and instruction builders for ValidationRegistry's full lifecycle.

Source: [`trustgate/sdk/`](https://github.com/mohit-1710/AgentTrust/tree/main/trustgate/sdk). License: MIT.

## Install

```bash
pnpm add @monad-agenttrust-sdk/sdk
# or: npm install @monad-agenttrust-sdk/sdk
# or: yarn add @monad-agenttrust-sdk/sdk
```
...
import { composeAtomicSettleTx }            from "@monad-agenttrust-sdk/sdk";
```
...
import { gatePayment } from "@monad-agenttrust-sdk/sdk/client";
