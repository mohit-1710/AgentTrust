...
| File | Purpose |
|---|---|
| [`trustgate/server/src/x402.ts`](https://github.com/mohit-1710/AgentTrust/blob/main/trustgate/server/src/x402.ts) | x402 wire envelope helpers |
| [`trustgate/sdk/src/express.ts`](https://github.com/mohit-1710/AgentTrust/blob/main/trustgate/sdk/src/express.ts) | Published Express middleware |
| [`trustgate/server/src/facilitators/`](https://github.com/mohit-1710/AgentTrust/tree/main/trustgate/server/src/facilitators) | Per-facilitator adapter implementations |
