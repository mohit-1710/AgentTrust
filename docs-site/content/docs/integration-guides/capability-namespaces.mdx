...
Source: [`programs/validation-registry/src/instructions/register_namespace.rs`](https://github.com/mohit-1710/AgentTrust/blob/main/programs/validation-registry/src/instructions/register_namespace.rs). State: [`state/capability_namespace.rs`](https://github.com/mohit-1710/AgentTrust/blob/main/programs/validation-registry/src/state/capability_namespace.rs).
...
```ts
import { deriveCapabilityNamespacePda } from "@monad-agenttrust-sdk/sdk";
...
The playbook-level descriptive labels in [`docs/plan/research/06-validation-registry-class.md`](https://github.com/mohit-1710/AgentTrust/blob/main/docs/plan/research/06-validation-registry-class.md) (e.g., `kyc.tier-1.v1.identity-verified`) decompose to these on-chain `name` strings plus the JSON `description` field. The chain stores the bounded name; richer metadata lives in the `schema_uri` document.
