...
- Policy module: [`policies/counterparty_tier.rs`](https://github.com/mohit-1710/AgentTrust/blob/main/programs/policy-vault/src/policies/counterparty_tier.rs)
- AtomStats parser: [`ext/ReputationRegistry.rs`](https://github.com/mohit-1710/AgentTrust/blob/main/programs/policy-vault/src/ext/ReputationRegistry.rs)
- Kani proof: [`proofs/inv_counterparty_tier_monotone.rs`](https://github.com/mohit-1710/AgentTrust/blob/main/programs/policy-vault/src/proofs/inv_counterparty_tier_monotone.rs)
