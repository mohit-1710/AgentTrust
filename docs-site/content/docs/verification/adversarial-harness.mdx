...
Source: [`tests/adversarial.spec.ts`](https://github.com/mohit-1710/AgentTrust/blob/main/tests/adversarial.spec.ts). Run via `forge test  --chain anvil`.
...
- Test file: [`tests/adversarial.spec.ts`](https://github.com/mohit-1710/AgentTrust/blob/main/tests/adversarial.spec.ts)
- Helper fixtures: [`tests/helpers/`](https://github.com/mohit-1710/AgentTrust/tree/main/tests/helpers)
